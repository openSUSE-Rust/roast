...
fn different_revisions_pointing_to_the_same_commit_produce_the_same_files() -> io::Result<()>
{
    ...
    let r1 = RoastScmArgs {
        ...
        changesemail: None,
        changesoutfile: None,
        git_repository_url: "https://github.com/openSUSE-Rust/obs-service-cargo".to_string(),
        exclude: None,
        revision: "v5.1.0".to_string(),
    ...
    let r2 = RoastScmArgs {
        ...
        git_repository_url: "https://github.com/openSUSE-Rust/obs-service-cargo".to_string(),
        exclude: None,
        revision: "2910335f66158a658dfeebca8b8bf6cfc09ba1c0".to_string(),
        versionrewriteregex: None,
        versionrewritepattern: None,
        depth: 0,
        is_temporary: true,
...
fn repo_with_submodules_1() -> io::Result<()>
{
    ...
    let r1 = RoastScmArgs {
        ...
        changesemail: None,
        changesoutfile: None,
        git_repository_url: "https://github.com/denoland/deno".to_string(),
        exclude: None,
